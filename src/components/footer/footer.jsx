...
const socialLinks = [
    ...
    { url: 'mailto:raajeshmani19@gmail.com', icon: 'fa fa-envelope', label: 'Mail' },
...
export const Footer = () => {
    ...
    const onClickAction = (social) => {
        ...
        typeof window !== "undefined" && window.gtag("event", "click", { label: social.label, url: social.url, click: "Social Link" })
    }
